      ...
      <AnimatePresence>
          {cart?.item_quantity > 0 && (
            <motion.button 
              ...
              exit={{ x: 50 }}
              className="fixed top-24 z-50 right-0 pl-3 pr-5 py-2 w-[50px] text-gray-700 font-semibold rounded-l-full bg-yellow-500  hover:bg-red-500 shadow-md focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50">
              {cart?.item_quantity || 0}
            </motion.button>
          )}
        </AnimatePresence>
